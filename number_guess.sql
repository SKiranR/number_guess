...
ALTER SEQUENCE public.users_user_id_seq OWNED BY public.users.u_id;
...
ALTER TABLE ONLY public.users ALTER COLUMN u_id SET DEFAULT nextval('public.users_user_id_seq'::regclass);
